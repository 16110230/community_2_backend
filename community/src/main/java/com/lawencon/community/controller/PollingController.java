...
public class PollingController {
	...
	@PostMapping
	public ResponseEntity<PojoInsertRes> insert(@RequestBody @Valid InsertPollingMainReq data) throws Exception {
		PojoInsertRes result = pollingService.insert(data);
