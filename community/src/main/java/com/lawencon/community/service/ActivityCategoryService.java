...
public class ActivityCategoryService extends BaseCoreService {
	...
	public PojoInsertRes insert(InsertActivityCategoryReq data) throws Exception {
		...
		try {
			...
			ActivityCategory result = activityCategoryDao.save(insert);
	...
	public PojoUpdateRes update(UpdateActivityCategoryReq data) throws Exception {
		ActivityCategory update = new ActivityCategory();
		...
		try {
			...
			ActivityCategory result = activityCategoryDao.save(update);
